...
public class DeferredRegisters {
    ...
    public static final RegistryObject<TileEntityType<TileElevatorBelt>> TILE_ELEVATORBELT = TILES.register("elevatorbelt",
	    () -> new TileEntityType<>(TileElevatorBelt::new, Sets.newHashSet(blockElevatorBelt), null));
