...
public class AssemblyLineLangKeyProvider extends BaseLangKeyProvider {
    ...
    public AssemblyLineLangKeyProvider(DataGenerator gen, Locale locale) {
        super(gen, locale, AssemblyLine.ID);
    }
    ...
    protected void addTranslations() {
        ...
        switch (locale) {
            ...
            default:
            	...
            	add("itemGroup.itemgroup" + AssemblyLine.ID + "main", "Assembly Line");
                ...
                addBlock(AssemblyLineBlocks.BLOCKS_ASSEMBLYMACHINES.getValue(SubtypeAssemblyMachine.cratemedium), "Medium Crate");
                addBlock(AssemblyLineBlocks.BLOCKS_ASSEMBLYMACHINES.getValue(SubtypeAssemblyMachine.cratelarge), "Large Crate");
                addBlock(AssemblyLineBlocks.BLOCKS_ASSEMBLYMACHINES.getValue(SubtypeAssemblyMachine.autocrafter), "Autocrafter");
                addBlock(AssemblyLineBlocks.BLOCKS_ASSEMBLYMACHINES.getValue(SubtypeAssemblyMachine.blockbreaker), "Block Breaker");
                addBlock(AssemblyLineBlocks.BLOCKS_ASSEMBLYMACHINES.getValue(SubtypeAssemblyMachine.blockplacer), "Block Placer");
