...
public class AssemblyLineCraftingTableRecipes extends AbstractRecipeGenerator {
	...
	ShapedCraftingRecipeBuilder
		.start(AssemblyLineItems.ITEMS_ASSEMBLYMACHINE.getValue(SubtypeAssemblyMachine.crate), 1)
		//
		.addPattern("IBI")
		//
		.addPattern("ICI")
	...
	ShapedCraftingRecipeBuilder
		.start(AssemblyLineItems.ITEMS_ASSEMBLYMACHINE.getValue(SubtypeAssemblyMachine.cratemedium), 1)
		//
		.addPattern("SCS")
		//
	...
	ShapedCraftingRecipeBuilder
		.start(AssemblyLineItems.ITEMS_ASSEMBLYMACHINE.getValue(SubtypeAssemblyMachine.cratelarge), 1)
		//
		.addPattern("MCM")
		//
	...
	/*
	 * ShapedCraftingRecipeBuilder.start(AssemblyLineItems.
	 * ITEM_SPEEDUPGRADE_ADVANCED.get(), 1) // .addPattern("PGP") //
	 * .addPattern("BWB") // .addPattern("CGC") // .addKey('P',
	 * Tags.Items.INGOTS_IRON) // .addKey('G', Tags.Items.STORAGE_BLOCKS_REDSTONE)
	 * // .addKey('B',
	 * ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.basicspeed))
	 * // .addKey('W', Tags.Items.INGOTS_COPPER) // .addKey('C',
	 * Tags.Items.INGOTS_GOLD) // .addConditions(ELECTRO_NOT_LOADED) //
	 * .complete(Electrodynamics.ID, "upgrade_advanced_speed_noelectro", output);
	 * 
	 * ShapedCraftingRecipeBuilder.start(AssemblyLineItems.ITEM_SPEEDUPGRADE_BASIC.
	 * get(), 1) // .addPattern("PGP") // .addPattern("WWW") // .addPattern("CGC")
	 * // .addKey('P', Tags.Items.INGOTS_IRON) // .addKey('G',
	 * Tags.Items.STORAGE_BLOCKS_REDSTONE) // .addKey('W', Tags.Items.INGOTS_GOLD)
	 * // .addKey('C', Tags.Items.INGOTS_COPPER) //
	 * .addConditions(ELECTRO_NOT_LOADED) // .complete(Electrodynamics.ID,
	 * "upgrade_basic_speed_noelectro", output);
	 * 
	 * ShapedCraftingRecipeBuilder.start(AssemblyLineItems.ITEM_UPGRADEITEMINPUT.get
	 * (), 1) // .addPattern("C") // .addPattern("P") // .addPattern("A") //
	 * .addKey('A', Tags.Items.INGOTS_GOLD) // .addKey('C',
	 * Tags.Items.DUSTS_REDSTONE) // .addKey('P', Items.STICKY_PISTON) //
	 * .addConditions(ELECTRO_NOT_LOADED) // .complete(Electrodynamics.ID,
	 * "upgrade_item_input_noelectro", output);
	 * 
	 * ShapedCraftingRecipeBuilder.start(AssemblyLineItems.ITEM_UPGRADEITEMOUTPUT.
	 * get(), 1) // .addPattern("C") // .addPattern("P") // .addPattern("A") //
	 * .addKey('A', Tags.Items.INGOTS_GOLD) // .addKey('C',
	 * Tags.Items.DUSTS_REDSTONE) // .addKey('P', Items.PISTON) //
	 * .addConditions(ELECTRO_NOT_LOADED) // .complete(Electrodynamics.ID,
	 * "upgrade_item_output_noelectro", output);
	 * 
	 * ShapedCraftingRecipeBuilder.start(AssemblyLineItems.ITEM_UPGRADERANGE.get(),
	 * 1) // .addPattern("PWP") // .addPattern("WBW") // .addPattern("PWP") //
	 * .addKey('P', Tags.Items.INGOTS_IRON) // .addKey('W',
	 * Tags.Items.INGOTS_COPPER) // .addKey('B', Tags.Items.DUSTS_REDSTONE) //
	 * .addConditions(ELECTRO_NOT_LOADED) // .complete(Electrodynamics.ID,
	 * "upgrade_range_noelectro", output);
	 */
	addMachines(output);
	...
	ShapedCraftingRecipeBuilder
		.start(AssemblyLineItems.ITEMS_ASSEMBLYMACHINE.getValue(SubtypeAssemblyMachine.autocrafter), 1)
		//
		.addPattern("GBG")
		//
		.addPattern("CTC")
	...
	ShapedCraftingRecipeBuilder
		.start(AssemblyLineItems.ITEMS_ASSEMBLYMACHINE.getValue(SubtypeAssemblyMachine.blockbreaker), 1)
		//
		.addPattern("CPC")
		//
		.addPattern("COC")
	...
	ShapedCraftingRecipeBuilder
		.start(AssemblyLineItems.ITEMS_ASSEMBLYMACHINE.getValue(SubtypeAssemblyMachine.blockplacer), 1)
		//
		.addPattern("CPC")
		//
		.addPattern("COC")
	...
	ShapedCraftingRecipeBuilder
		.start(AssemblyLineItems.ITEMS_ASSEMBLYMACHINE.getValue(SubtypeAssemblyMachine.farmer), 1)
		//
		.addPattern("PSP")
		//
		.addPattern("ACH")
	...
	ShapedCraftingRecipeBuilder
		.start(AssemblyLineItems.ITEMS_ASSEMBLYMACHINE.getValue(SubtypeAssemblyMachine.mobgrinder), 1)
		//
		.addPattern("PSP")
		//
		.addPattern("SCS")
	...
	ShapedCraftingRecipeBuilder
		.start(AssemblyLineItems.ITEMS_ASSEMBLYMACHINE.getValue(SubtypeAssemblyMachine.rancher), 1)
		//
		.addPattern("PSP")
		//
		.addPattern("SCS")
