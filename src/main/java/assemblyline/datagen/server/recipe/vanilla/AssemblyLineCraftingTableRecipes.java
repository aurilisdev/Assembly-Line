...
public class AssemblyLineCraftingTableRecipes extends AbstractRecipeGenerator {
	...
	/*
	 * CustomShapedCraftingRecipe.start(AssemblyLineItems.ITEM_SPEEDUPGRADE_ADVANCED
	 * .get(), 1) // .addPattern("PGP") // .addPattern("BWB") // .addPattern("CGC")
	 * // .addKey('P', Tags.Items.INGOTS_IRON) // .addKey('G',
	 * Tags.Items.STORAGE_BLOCKS_REDSTONE) // .addKey('B',
	 ...
	 * 
	 * CustomShapedCraftingRecipe.start(AssemblyLineItems.ITEM_SPEEDUPGRADE_BASIC.
	 ...
	 * "upgrade_basic_speed", output);
	 * 
	 * CustomShapedCraftingRecipe.start(AssemblyLineItems.ITEM_UPGRADEITEMINPUT.get(
	 ...
	 * .addConditions(ELECTRO_NOT_LOADED) // .complete(Electrodynamics.ID,
	 * "upgrade_item_input", output);
	 * 
	 * CustomShapedCraftingRecipe.start(AssemblyLineItems.ITEM_UPGRADEITEMOUTPUT.get
	 * (), 1) // .addPattern("C") // .addPattern("P") // .addPattern("A") //
	 * .addKey('A', Tags.Items.INGOTS_GOLD) // .addKey('C',
	 * Tags.Items.DUSTS_REDSTONE) // .addKey('P', Items.PISTON) //
	 * .addConditions(ELECTRO_NOT_LOADED) // .complete(Electrodynamics.ID,
	 * "upgrade_item_output", output);
	 * 
	 * CustomShapedCraftingRecipe.start(AssemblyLineItems.ITEM_UPGRADERANGE.get(),
    ...
    public void addMachines(Consumer<FinishedRecipe> output) {
