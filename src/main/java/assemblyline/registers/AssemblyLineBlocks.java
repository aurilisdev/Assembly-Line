...
public class AssemblyLineBlocks {
    ...
    public static final DeferredHolder<Block, BlockConveyorBelt> BLOCK_CONVEYORBELT = BLOCKS.register("conveyorbelt",
	    () -> new BlockConveyorBelt(AssemblyLineVoxelShapes.CONVEYORBELT, TileConveyorBelt::new));
    public static final DeferredHolder<Block, BlockConveyorBelt> BLOCK_SORTERBELT = BLOCKS.register("sorterbelt",
	    () -> new BlockConveyorBelt(VoxelShapeProvider.DEFAULT, TileSorterBelt::new));
    public static final DeferredHolder<Block, BlockDetector> BLOCK_DETECTOR = BLOCKS.register("detector",
	    BlockDetector::new);
    public static final BulkDeferredHolder<Block, BlockMachine, SubtypeAssemblyMachine> BLOCKS_ASSEMBLYMACHINES = new BulkDeferredHolder<>(
