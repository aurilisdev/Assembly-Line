...
public class ChapterConveyers extends Chapter {
	...
	public void addData() {
		...
		// Sorter Belt
		pageData.add(new TextWrapperObject(AssemblyLineItems.ITEM_SORTERBELT.get().getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
		...
		// Detector
		pageData.add(new TextWrapperObject(AssemblyLineItems.ITEM_DETECTOR.get().getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
