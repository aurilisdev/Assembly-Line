...
public class ChapterMachines extends Chapter {
	...
	public void addData() {
		...
		// Block Breaker
		pageData.add(new TextWrapperObject(AssemblyLineItems.ITEMS_ASSEMBLYMACHINE.getValue(SubtypeAssemblyMachine.blockbreaker).getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered());
		...
		// Block Placer
		pageData.add(new TextWrapperObject(AssemblyLineItems.ITEMS_ASSEMBLYMACHINE.getValue(SubtypeAssemblyMachine.blockplacer).getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
		...
		// Energized Rancher
		pageData.add(new TextWrapperObject(AssemblyLineItems.ITEMS_ASSEMBLYMACHINE.getValue(SubtypeAssemblyMachine.rancher).getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
		...
		// Mob Grinder
		pageData.add(new TextWrapperObject(AssemblyLineItems.ITEMS_ASSEMBLYMACHINE.getValue(SubtypeAssemblyMachine.mobgrinder).getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
		...
		// Farmer
		pageData.add(new TextWrapperObject(AssemblyLineItems.ITEMS_ASSEMBLYMACHINE.getValue(SubtypeAssemblyMachine.farmer).getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
