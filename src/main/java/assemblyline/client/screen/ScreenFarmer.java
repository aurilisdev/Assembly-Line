...
//
    ...
    public ScreenFarmer(ContainerFarmer container, PlayerInventory inv, ITextComponent titleIn) {
    ...
    private List<? extends IReorderingProcessor> getElectricInformation() {
        ...
        if (farmer != null) {
            ...
            list.add(AssemblyTextUtils.gui("machine.usage", ChatFormatter.getChatDisplayShort(AssemblyLineConstants.FARMER_USAGE * farmer.powerUsageMultiplier.getValue() * 20, DisplayUnits.WATT).withStyle(TextFormatting.GRAY)).withStyle(TextFormatting.DARK_GRAY).getVisualOrderText());
