...
public class RenderMobGrinder extends AbstractTileRenderer<TileMobGrinder> {
	...
	double progress = 0;
	if (grinder.<ComponentElectrodynamic>requireComponent(IComponentType.Electrodynamic)
		.getJoulesStored() >= AssemblyLineConfig.getInstance().MOBGRINDER_USAGE.getAsDouble()
