...
public class TileBlockPlacer extends TileOutlineArea {
    ...
    public void tickServer(ComponentTickable tickable) {
        ...
        if (!stack.isEmpty() && stack.getItem() instanceof BlockItem) {
            ...
            BlockState newState = b.getStateForPlacement(new BlockItemUseContext(level, null, Hand.MAIN_HAND, stack, new BlockRayTraceResult(Vector3d.ZERO, facing, off, false)));
