...
public abstract class TileOutlineArea extends GenericTile {
	...
	protected TileOutlineArea(TileEntityType<?> type) {
		super(type);
	}

	public AxisAlignedBB getAABB(int width, int length, int height, boolean isFlipped) {
	...
	public static AxisAlignedBB encapsulatingFullBlocks(BlockPos startPos, BlockPos endPos) {
