...
public class TileMobGrinder extends TileOutlineArea {
	...
	addComponent(new ComponentElectrodynamic(this, false, true)
		...
		.voltage(VoltaicCapabilities.DEFAULT_VOLTAGE).maxJoules(AssemblyLineConstants.MOBGRINDER_USAGE * 40));
	...
	if (electro.getJoulesStored() < AssemblyLineConstants.MOBGRINDER_USAGE * powerUsageMultiplier.getValue()
		|| !inv.areOutputsEmpty()) {
	    return;
	}
	...
	for (Entity entity : entities) {
	    ...
	    storage.setLocation(0, getBlockPos().getX(), getBlockPos().getY(), getBlockPos().getZ());
