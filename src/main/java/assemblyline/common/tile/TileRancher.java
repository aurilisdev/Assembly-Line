...
public class TileRancher extends TileOutlineArea {
	...
	addComponent(new ComponentElectrodynamic(this, false, true)
		...
		.voltage(VoltaicCapabilities.DEFAULT_VOLTAGE).maxJoules(AssemblyLineConstants.RANCHER_USAGE * 20));
	...
	for (Entity entity : entities) {
	    ...
	    if (entity instanceof IForgeShearable sheep && sheep.isShearable(null, level, entity.blockPosition())) {

		collectedItems
			.addAll(sheep.onSheared(null, new ItemStack(Items.SHEARS), level, entity.blockPosition(), 0));
