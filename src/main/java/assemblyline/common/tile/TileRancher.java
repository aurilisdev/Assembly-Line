...
public class TileRancher extends TileOutlineArea {
	...
	public TileRancher() {
		super(AssemblyLineTiles.TILE_RANCHER.get());
	...
	public void tickServer(ComponentTickable tickable) {
		...
		for (Entity entity : entities) {
			...
			if (entity instanceof IForgeShearable && ((IForgeShearable) entity).isShearable(null, level, entity.blockPosition())) {
				
				collectedItems.addAll(((IForgeShearable) entity).onSheared(null, new ItemStack(Items.SHEARS), level, entity.blockPosition(), 0));
